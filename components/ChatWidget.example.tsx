    ...
    messages: [
      {
        ...
        parts: [{ type: 'text' as const, text: 'Halo! Saya asisten AI milik [YOUR_NAME]. Anda bisa menanyakan pengalaman kerja, Tech Stack, atau proyek yang pernah saya kerjakan. Apa yang ingin Anda ketahui?' }],
      }
    ],
    onError: (error: any) => {
          ...
          >
            ...
            <div className="flex items-center justify-between px-4 py-3 bg-black-200 border-b border-white-100/10">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-semibold text-white text-sm">[YOUR_NAME]'s AI Twin</h3>
