...
export const gridItems = [
  {
    id: 1,
    title:
      "I build end-to-end digital solutions that merge robust back-end architecture with polished, intuitive front-end experiences.",
    description:
      "Full-Stack Developer specializing in crafting seamless user experiences",
